...
Begin VB.Form pf_cadramo 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cadastro do Ramo de Atividade"
   ClientHeight    =   4500
   ClientLeft      =   465
   ClientTop       =   1080
   ClientWidth     =   9165
...
Dim cpo(1) As String 'NOME DOS CAMPOS
Dim tcpo(1) As String 'TIPO DOS CAMPOS
